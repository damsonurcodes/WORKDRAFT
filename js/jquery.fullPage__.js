    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function scrollPage(element, callback, isMovementUp){
            ...
            //local variables
            // console.log(element.find(SLIDE_ACTIVE_SEL));
            console.log('p');
            console.log(element.find(SLIDE_SEL));
            var slides = element.find(SLIDE_SEL);
            var v = 'reset';
        ...
        */
        function performHorizontalMove(slides, v, fireCallback){
            ...
            if(v == 'reset') {
                console.log('reset');
                // console.log(slides.find(SLIDES_CONTAINER_SEL));
                var translate3d = 'translate3d(0px, 0px, 0px)';
                $('.fp-slide').removeClass('active');
                $(".article").scrollTop(1)
                
                $('.fp-slide').addClass('active');
                // $(this).addClass('active');
                $('.fp-slidesContainer').css(getTransforms(translate3d));
                ...
                if(options.css3){
                    console.log('min');
                    // $( "div.article" ).scrollTop(1);
                    console.log($( "div.article" ).scrollTop(1));
                    // $(window).scrollTop();
                    // $('.article').scrollView();
        ...
        */
        function setBodyClass(){
            ...
            // var translate3d = 'translate3d(0px, 0px, 0px)';
            // //
            // addAnimation('.fp-slidesContainer').css(getTransforms(translate3d));
        }
